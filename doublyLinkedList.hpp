...
class Node {
	friend class DoublyLinkedList<NodeType>;	// Using firend class for use private variable in DoublyLinkedList class
	private:
		NodeType data;
		Node<NodeType> *prev;
		Node<NodeType> *next;
...
template <typename T>
void DoublyLinkedList<T>::insert(int pos, T data) {
